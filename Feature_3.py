...
st.markdown("# Storm Drain Education and Prevention: Translation ♻️")
...
def translate(text, source_language = "English", target_language = "French"):
    # Customize the prompt for storm drain education and prevention translation
    prompt = ("You are provided with a sentence regarding storm drain education and prevention in " + source_language
